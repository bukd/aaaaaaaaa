local espcolor = Color3.fromRGB(118, 37, 217)
...
CheatType.Text = "ESP Loop : Desativado"
...
CheatType_2.Text = "VERSAO TRADUZIDA DO CC AIMBOT"
...
CheatType_3.Text = "Modo de jogo : true"
...
CheatType_5.Text = "Aimbot indetectavel"
...
CheatType_8.Text = "Travar a mira"
...
TabFrame.BackgroundColor3 = Color3.fromRGB(118, 37, 217)
...
if TeamBased == true then
TeamBased = false
CheatType_3.Text = "Modo de jogo : "..tostring(TeamBased)
else
TeamBased = true
CheatType_3.Text = "Modo de jogo : "..tostring(TeamBased)
end
