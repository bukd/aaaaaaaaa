...
EspStatus.Text = "Aperte T para atualizar o Esp"
...
st1.Text = "Aperte "..aimkey.." para travar a mira em um jogador"
...
st1_2.Text = "Aperte L para habilitar o loop do esp.         Aperte Y para desabilitar/habilitar o aimbot indetectavel"
...
st1_3.Text = "Aperte O para alterar o modo de jogo"
...
teambasedstatus.Text = "Modo de jogo: "..tostring(TeamBased)
...
Name.Text = "FPS gui by Bukd v"..ver
